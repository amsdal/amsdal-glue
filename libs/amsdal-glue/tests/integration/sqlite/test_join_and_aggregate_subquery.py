...
def _register_default_connection() -> Generator[None, None, None]:
    ...
    connection_mng.register_connection_pool(
        DefaultConnectionPool(SqliteConnection, db_path=FIXTURES_PATH / 'cities_2.sqlite'),
        schema_name='cities',
    )

    connection_mng.register_connection_pool(
        DefaultConnectionPool(SqliteConnection, db_path=FIXTURES_PATH / 'countries_2.sqlite'),
...
def test_final_query() -> None:
    ...
    data_result = service.execute(DataQueryOperation(query=final_query))
