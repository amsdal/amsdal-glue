...
@pytest.mark.asyncio
async def test_insert_data_single_element(register_default_connection: AsyncGenerator[None, None]) -> None:  # noqa: ARG001
    connection_mng = Container.managers.get(AsyncConnectionManager)
    query = DataCommand(
        lock_id=None,
        transaction_id=None,
...
@pytest.mark.asyncio
async def test_update_data_single_element(register_default_connection: AsyncGenerator[None, None]) -> None:  # noqa: ARG001
    connection_mng = Container.managers.get(AsyncConnectionManager)
    await (await connection_mng.get_connection_pool('shippings').get_connection()).execute(  # type: ignore[attr-defined]
...
@pytest.mark.asyncio
async def test_delete_data_single_element(register_default_connection: AsyncGenerator[None, None]) -> None:  # noqa: ARG001
    connection_mng = Container.managers.get(AsyncConnectionManager)
    await (await connection_mng.get_connection_pool('shippings').get_connection()).execute(  # type: ignore[attr-defined]
        'INSERT INTO shippings (id, customer_id, status) '
        'VALUES ("111", "1", "shipped"), ("222", "2", "shipped"), ("333", "3", "shipped")'
...
@pytest.mark.asyncio
async def test_create_and_update_data_single_element(register_default_connection: AsyncGenerator[None, None]) -> None:  # noqa: ARG001
    connection_mng = Container.managers.get(AsyncConnectionManager)
    query = DataCommand(
        lock_id=None,
        transaction_id=None,
...
@pytest.mark.asyncio
async def test_create_and_delete_data_single_element(register_default_connection: AsyncGenerator[None, None]) -> None:  # noqa: ARG001
    connection_mng = Container.managers.get(AsyncConnectionManager)
    query = DataCommand(
        lock_id=None,
        transaction_id=None,
...
@pytest.mark.asyncio
async def test_create_multiple_data_elements(register_default_connection: AsyncGenerator[None, None]) -> None:  # noqa: ARG001
    connection_mng = Container.managers.get(AsyncConnectionManager)
    query = DataCommand(
        lock_id=None,
        transaction_id=None,
