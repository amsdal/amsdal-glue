...
@pytest.mark.asyncio
async def test_query_execute_query_to_single_model(register_default_connection: None) -> None:  # noqa: ARG001
...
@pytest.mark.asyncio
async def test_query_execute_distinct(register_default_connection: None) -> None:  # noqa: ARG001
    query = QueryStatement(
        only=[
            FieldReference(field=Field(name='first_name'), table_name='c'),
        ],
...
@pytest.mark.asyncio
async def test_query_execute_distinct_multiple_fields(register_default_connection: None) -> None:  # noqa: ARG001
    query = QueryStatement(
        only=[
            FieldReference(field=Field(name='first_name'), table_name='c'),
...
@pytest.mark.asyncio
async def test_query_execute_distinct_on_single_field(register_default_connection: None) -> None:  # noqa: ARG001
    query = QueryStatement(
        only=[
            FieldReference(field=Field(name='first_name'), table_name='c'),
        ],
...
@pytest.mark.asyncio
async def test_query_execute_distinct_on_multiple(register_default_connection: None) -> None:  # noqa: ARG001
    query = QueryStatement(
        only=[
            FieldReference(field=Field(name='first_name'), table_name='c'),
            FieldReference(field=Field(name='last_name'), table_name='c'),
