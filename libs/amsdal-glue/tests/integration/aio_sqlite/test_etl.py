...
async def register_default_connection() -> AsyncGenerator[None, None]:
    ...
    connection_mng.register_connection_pool(
        DefaultAsyncConnectionPool(AsyncSqliteConnection, db_path=FIXTURES_PATH / 'cities.sqlite'),
        schema_name='cities',
    )

    connection_mng.register_connection_pool(
        DefaultAsyncConnectionPool(AsyncSqliteConnection, db_path=FIXTURES_PATH / 'countries.sqlite'),
        schema_name='countries',
    )

    connection_mng.register_connection_pool(
        DefaultAsyncConnectionPool(AsyncSqliteConnection, db_path=FIXTURES_PATH / 'countries_map.sqlite'),
    )
