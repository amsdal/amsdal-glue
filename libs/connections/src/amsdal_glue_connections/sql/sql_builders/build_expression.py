...
def build_expression(
    ...
    if isinstance(expression, CombinedExpression):
        left_stmt, left_params = build_expression(expression.left, transform)
        right_stmt, right_params = build_expression(expression.right, transform)
        stmt = f'{left_stmt} {expression.operator} {right_stmt}'
        stmt = transform.apply(TransformTypes.CAST, stmt, expression.output_type)
