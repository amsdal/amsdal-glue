...
def query_customers_age(database_connection: ElasticsearchConnection, *, distinct: bool = False) -> list[Data]:
...
def query_big_orders(database_connection: ElasticsearchConnection) -> list[Data]:
    return database_connection.query(
        QueryStatement(
            table=SchemaReference(name='orders', alias='o', version=Version.LATEST),
            order_by=[
...
def query_orders_for_customer(database_connection: ElasticsearchConnection) -> list[Data]:
    return database_connection.query(
        QueryStatement(
            table=SchemaReference(name='orders', alias='o', version=Version.LATEST),
            order_by=[
...
def query_customers_expenses(database_connection: ElasticsearchConnection) -> list[Data]:
    return database_connection.query(
        QueryStatement(
            only=[
...
def query_expenses_by_customer(database_connection: ElasticsearchConnection) -> list[Data]:
    return database_connection.query(
        query=QueryStatement(
            table=SchemaReference(name='orders', alias='o', version=Version.LATEST),
            only=[
...
def query_expenses_by_customer_with_name(database_connection: ElasticsearchConnection) -> list[Data]:
    return database_connection.query(
        query=QueryStatement(
...
def query_multiple_aggregations(database_connection: ElasticsearchConnection) -> list[Data]:
...
def query_count_distinct(database_connection: ElasticsearchConnection) -> list[Data]:
...
def query_customers_with_multiple_annotations(database_connection: ElasticsearchConnection) -> list[Data]:
...
def query_customers_with_conditional_annotation(database_connection: ElasticsearchConnection) -> list[Data]:
