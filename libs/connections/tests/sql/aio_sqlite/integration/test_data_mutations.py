...
from tests.sql.aio_sqlite.testcases.data_mutations import delete_customer
from tests.sql.aio_sqlite.testcases.data_mutations import insert_customers_and_orders
from tests.sql.aio_sqlite.testcases.data_mutations import simple_customer_insert
from tests.sql.aio_sqlite.testcases.data_mutations import update_two_customers
...
@pytest.mark.asyncio
async def test_insert(fixture_connection: AsyncGenerator[AsyncSqliteConnection, None]) -> None:
...
@pytest.mark.asyncio
async def test_insert_multiple(fixture_connection: AsyncGenerator[AsyncSqliteConnection, None]) -> None:
    async for fc in fixture_connection:
...
@pytest.mark.asyncio
async def test_update(fixture_connection: AsyncGenerator[AsyncSqliteConnection, None]) -> None:
    async for fc in fixture_connection:
...
@pytest.mark.asyncio
async def test_delete(fixture_connection: AsyncGenerator[AsyncSqliteConnection, None]) -> None:
    async for fc in fixture_connection:
