...
@pytest.mark.asyncio
async def test_insert(fixture_connection: AsyncSqliteConnection) -> None:
...
@pytest.mark.asyncio
async def test_insert_multiple(fixture_connection: AsyncSqliteConnection) -> None:
...
@pytest.mark.asyncio
async def test_update(fixture_connection: AsyncSqliteConnection) -> None:
...
@pytest.mark.asyncio
async def test_delete(fixture_connection: AsyncSqliteConnection) -> None:
