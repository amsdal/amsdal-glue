...
async def fixture_connection(
    database_connection: AsyncGenerator[AsyncSqliteConnection, None],
) -> AsyncGenerator[AsyncSqliteConnection, None]:
    async for dc in database_connection:
        ...
        await dc.execute('INSERT INTO customers (id, name, age) VALUES (?, ?, ?)', 1, 'Alice', 25)
        await dc.execute('INSERT INTO customers (id, name, age) VALUES (?, ?, ?)', 2, 'Bob', 25)
        await dc.execute('INSERT INTO customers (id, name, age) VALUES (?, ?, ?)', 3, 'Charlie', 35)
        await dc.execute('INSERT INTO orders (id, customer_id, amount) VALUES (?, ?, ?)', 1, 1, 100)
        await dc.execute('INSERT INTO orders (id, customer_id, amount) VALUES (?, ?, ?)', 2, 1, 200)
        await dc.execute('INSERT INTO orders (id, customer_id, amount) VALUES (?, ?, ?)', 3, 2, 400)

        yield dc


@pytest.mark.asyncio
async def test_simple_query(fixture_connection: AsyncGenerator[AsyncSqliteConnection, None]) -> None:
...
@pytest.mark.asyncio
async def test_join_query(fixture_connection: AsyncGenerator[AsyncSqliteConnection, None]) -> None:
    async for fc in fixture_connection:
...
@pytest.mark.asyncio
async def test_query_distinct(fixture_connection: AsyncGenerator[AsyncSqliteConnection, None]) -> None:
    async for fc in fixture_connection:
...
@pytest.mark.asyncio
async def test_filter_conditions(fixture_connection: AsyncGenerator[AsyncSqliteConnection, None]) -> None:
    async for fc in fixture_connection:
...
@pytest.mark.asyncio
async def test_filter_conditions_join(fixture_connection: AsyncGenerator[AsyncSqliteConnection, None]) -> None:
    async for fc in fixture_connection:
...
@pytest.mark.asyncio
async def test_annotation(fixture_connection: AsyncGenerator[AsyncSqliteConnection, None]) -> None:
    async for fc in fixture_connection:
...
@pytest.mark.asyncio
async def test_aggregation(fixture_connection: AsyncGenerator[AsyncSqliteConnection, None]) -> None:
    async for fc in fixture_connection:
...
@pytest.mark.asyncio
async def test_aggregation_join(fixture_connection: AsyncGenerator[AsyncSqliteConnection, None]) -> None:
    async for fc in fixture_connection:
