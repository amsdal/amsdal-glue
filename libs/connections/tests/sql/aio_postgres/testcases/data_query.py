...
async def query_orders_with_customers(database_connection: AsyncPostgresConnection) -> list[Data]:
    return await database_connection.query(
        QueryStatement(
...
async def query_customers_age(database_connection: AsyncPostgresConnection, *, distinct: bool = False) -> list[Data]:
...
async def query_big_orders(database_connection: AsyncPostgresConnection) -> list[Data]:
    return await database_connection.query(
        QueryStatement(
            table=SchemaReference(name='orders', alias='o', version=Version.LATEST),
            order_by=[
...
async def query_orders_for_customer(database_connection: AsyncPostgresConnection) -> list[Data]:
    return await database_connection.query(
        QueryStatement(
            table=SchemaReference(name='orders', alias='o', version=Version.LATEST),
            order_by=[
...
async def query_customers_expenses(database_connection: AsyncPostgresConnection) -> list[Data]:
    return await database_connection.query(
        QueryStatement(
            only=[
...
async def query_expenses_by_customer(database_connection: AsyncPostgresConnection) -> list[Data]:
    return await database_connection.query(
        query=QueryStatement(
            table=SchemaReference(name='orders', alias='o', version=Version.LATEST),
            only=[
...
async def query_expenses_by_customer_with_name(database_connection: AsyncPostgresConnection) -> list[Data]:
    return await database_connection.query(
        query=QueryStatement(
